...
plt.title("Australian Continent Ambient Seismic Noise Power Density Spectra")
plt.xlabel('Frequency (Hz)')
plt.ylabel('Linear Power Density Spectrum (V RMS)')
...
for s in paths_list:
    ...
    try:
        ...
        plt.semilogy(spectra[:,0], spectra[:,1], c='k', alpha=0.1)
