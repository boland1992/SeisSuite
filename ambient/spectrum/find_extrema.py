...
def spectrum(tr):
    ...
    if nseg >= 256:
        f, Pxx_spec = signal.welch(wave, fs, 'flattop', nperseg=nseg, scaling='spectrum')
...
with open('maxima_dict0.pickle', 'wb') as f:
