...
fig1.savefig('network_spectrum/PDS_AU_2014.svg', format='svg', dpi=300)  
plt.clf()

fig2 = plt.figure(figsize=(15,10))
ax2 = fig1.add_subplot(111)    
ax2.set_title("Seismic Waveform Power Density Spectrum\n{}".format('S | 2014'))
ax2.set_xlabel('Frequency (Hz)')
ax2.set_ylabel('Power Density Spectrum (V RMS)')
ax2.set_xlim([0,4])
ax2.grid(True, axis='both', color='gray')
...
fig2.savefig('network_spectrum/PDS_S_2014.svg', format='svg', dpi=300)       
plt.clf()
