...
CODE DESCRIPTION: 
The following python script performs a plot of great-circle lines between all
combinations of seismic stations downloaded from the FDSN client network. This
uses the python Basemap module to achieve this and plot all necessary 
geospatial information on an editable background. 
"""
