...
LOCATIONS = {'Parana basin': (-51.5, -22.5),
             ...
             'Gippsland Basin': (146.74121, -38.26670),
             'Victoria Alpine National Park': (147.13122, -37.05348)
             }
NB_NEIGHBORS = 4
...
LOCAL_DZ_SEDIMENTS_BOUNDS = {'Parana basin': (2.5, 5.2),  # from Laske & Masters
                             ...
                             'Gippsland Basin': (2.8,3.1),
                             'Victoria Alpine National Park': (2.8,3.1)}
...
LOCAL_MOHO_DEPTH_BOUNDS = {'Parana basin': (39.0, 45.0),  # (42.0, 45.0),
                           ...
                           'Gippsland Basin': (30.0, 33.0),
                           'Victoria Alpine National Park': (30.0, 33.0)
...
# selecting velocity maps
print "Loading velocity maps"

flist = sorted(glob.glob(os.path.join(TOMO_DIR, '2-pass*.pickle*')))
print 'Select file(s) containing velocity map info to process: [All except backups]'
